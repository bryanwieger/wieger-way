...
RULES
─────
• Never ask more than 5–7 questions at once.
...
## Code Repos
<!--
List repositories that are relevant to the problem.
...
SUGGESTED THEMES (use, rename, or skip as appropriate):
  ...
  Problem & goals
    3. What does success look like in 30 days? In 6 months?
  ...
  Prioritization & timeline
    9.  Is there a hard deadline or launch event?
    10. Are there other features or work items that must ship first?
    11. What is out of scope for this iteration?
-->
1. 
